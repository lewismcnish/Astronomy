...
How well these templates fit the raw data varied greatly for all the events as some couldnt identify the correct values
...
As mentioned above the binary neutron star merger was not included in the previous analysis as it has a different mass range that is required to be
